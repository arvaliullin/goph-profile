...
func (m *MockObjectStorage) DeleteMany(ctx context.Context, keys []string) error {
	m.ctrl.T.Helper()
...
func (mr *MockObjectStorageMockRecorder) DeleteMany(ctx, keys any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteMany", reflect.TypeOf((*MockObjectStorage)(nil).DeleteMany), ctx, keys)
}
